...
const defaultState = {
    ...
    shortcuts: {
        ...
        clearOrganizationStatisticsSnapshots: '',
...
const SHORTCUT_DEFINITIONS = [
    ...
    { action: 'openMergeConflicts', label: 'Open Merge Conflict Resolution', defaultShortcut: defaultState.shortcuts.openMergeConflicts },
    ...
    { action: 'clearOrganizationStatisticsSnapshots', label: 'Clear Organization Statistics Snapshots', defaultShortcut: defaultState.shortcuts.clearOrganizationStatisticsSnapshots },
...
export function getAssignableActions() {
    const assignableActions = [
        ...
        { action: 'openMergeConflicts', label: 'Open Merge Conflict Resolution' },
        ...
        { action: 'clearOrganizationStatisticsSnapshots', label: 'Clear Organization Statistics Snapshots' },
