...
const shortcutControlMap = [
    ...
    { id: 's', action: 'focusLookup', label: 'Search and filter criteria' },
    ...
    { id: 'btn-open-working-view', action: 'openWorkingView', label: 'Open Working View' },
    ...
    { id: 'btn-working-view-exit', action: 'exitWorkingView', label: 'Exit Working View' },
    { id: 'btn-working-view-apply', action: 'applyWorkingView', label: 'Apply Working View' },
    { id: 'btn-working-view-save', action: 'saveWorkingView', label: 'Save Working View' },
    { id: 'btn-working-view-load', action: 'loadWorkingView', label: 'Load Working View' },
    { id: 'btn-working-view-delete', action: 'deleteWorkingView', label: 'Delete Working View' },
    { id: 'btn-working-view-refresh', action: 'refreshWorkingView', label: 'Refresh Working View' },
    { id: 'btn-working-view-reset', action: 'resetWorkingView', label: 'Reset Working View' },
    { id: 'btn-working-view-batch-status', action: 'batchSetWorkingViewStatus', label: 'Batch Set Status' },
    { id: 'btn-working-view-batch-reviewer', action: 'batchAssignWorkingViewReviewer', label: 'Batch Assign Reviewer' },
    { id: 'btn-working-view-batch-severity', action: 'batchSetWorkingViewSeverity', label: 'Batch Set Severity' },
    { id: 'btn-working-view-batch-tag', action: 'batchAddWorkingViewTag', label: 'Batch Add Tag' },
    { id: 'btn-working-view-apply-built-in-preset', action: 'setWorkingReportView', label: 'Apply Built-in Preset' },
    { id: 'btn-working-view-expand-all', action: 'expandAllWorkingViewGroups', label: 'Expand All Groups' },
    { id: 'btn-working-view-collapse-all', action: 'collapseAllWorkingViewGroups', label: 'Collapse All Groups' },
    { id: 'btn-working-view-next-finding', action: 'nextWorkingViewFinding', label: 'Next Finding' },
    { id: 'btn-working-view-previous-finding', action: 'previousWorkingViewFinding', label: 'Previous Finding' },
    { id: 'btn-working-view-next-group', action: 'nextWorkingViewGroup', label: 'Next Group' },
    { id: 'btn-working-view-previous-group', action: 'previousWorkingViewGroup', label: 'Previous Group' },
    ...
    { id: 'btn-workspace-tag-manager', action: 'openTagManager', label: 'Tag Manager' },
    { id: 'btn-workspace-collection-manager', action: 'openCollectionManager', label: 'Collection Manager' },
    { id: 'btn-workspace-saved-view-manager', action: 'openSavedViewManager', label: 'Saved View Manager' },
    { id: 'btn-workspace-open-saved-view', action: 'openSavedView', label: 'Open Saved View' },
    { id: 'btn-workspace-save-current-view', action: 'createSavedViewFromCurrentWorkingView', label: 'Save Current Working View' },
    ...
    { id: 'btn-template-rename', action: 'renameTemplate', label: 'Rename Template' },
    { id: 'btn-template-replace', action: 'replaceTemplate', label: 'Replace Template' },
    ...
    { id: 'btn-rename-report-dashboard', action: 'renameReport', label: 'Rename Report' },
    { id: 'btn-replace-report-dashboard', action: 'replaceReport', label: 'Replace Report' },
    ...
    { id: 'btn-open-working-view-dashboard', action: 'openWorkingView', label: 'Open Working View' },
    { id: 'btn-load-working-view-dashboard', action: 'loadWorkingView', label: 'Load Working View Preset' },
