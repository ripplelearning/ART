...
Assert-Contains 'reportEditor.js' $editor 'isWcagCriterionInRemovedWebRange' 'Web WCAG 1.1.1 through 4.1.3 filtering is missing.'
Assert-Contains 'reportEditor.js' $editor 'section508Wcag20ForProduct' 'Section 508 WCAG criteria are not product-filtered.'
Assert-Contains 'reportEditor.js' $editor 'software-interoperability' 'Software applicability filtering is missing.'
Assert-Contains 'reportEditor.js' $editor 'support-documentation' 'Support documentation applicability filtering is missing.'
