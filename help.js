    ...
    return [
        ...
        },
        {
            ...
            content: `
                ...
                <p>When a Section 508 report is active in Report Editor, ART displays the official report template with each performance criterion/test. Every row includes a <strong>Test Result</strong> dropdown with <strong>Pass</strong>, <strong>Fail</strong>, <strong>Not Applicable</strong>, and <strong>Not Tested</strong>, an <strong>Optional Comments</strong> textarea, and an <strong>Add Issue</strong> button for documenting multiple issues against the same criterion/test.</p>
