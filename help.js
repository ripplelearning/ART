    ...
    return [
        ...
        },
        {
            ...
            content: `
                ...
                <p>Section 508 Report Builder configuration requires <strong>Product Type</strong> Web, Electronic Document, Software, or Hardware, and <strong>Conformance Level</strong> Level A, Level AA, or Level AAA. Web and Software use separate supplied template resources. Testing Date(s) are required for Section 508 validation, and report-level Notes are available for overall observations.</p>
