    ...
    return [
        ...
        },
        {
            ...
            content: `
                ...
                <p>Once connected, use Open from Google Drive.../Save to Google Drive or Open from OneDrive.../Save to OneDrive on the Dashboard, File menu, or Command Palette. Opening lists .art files available to that provider; saving asks for a filename the first time and updates the same file afterward. These commands are available in the Keyboard Shortcut Manager without a default binding once connected.</p>
