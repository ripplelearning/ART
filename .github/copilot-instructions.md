...
* Do not assume `get\_errors` is sufficient for browser startup safety. If the UI only partially renders, inspect for misplaced object literals, malformed template strings, or invalid syntax inserted into executable function bodies.
...
Do not modify workflow configurations for GitHub Actions.
