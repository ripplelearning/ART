...
Run-VerifyScript 'verify-epic64.ps1'
Run-VerifyScript 'verify-epic65.ps1'
Run-VerifyScript 'verify-epic67.ps1'
Run-VerifyScript 'verify-epic68.ps1'
Run-VerifyScript 'verify-epic68-onboarding.ps1'
Run-VerifyScript 'verify-epic69.ps1'
Run-VerifyScript 'verify-settings-tabs.ps1'
Run-VerifyScript 'verify-deferred-tracker.ps1'
Run-VerifyScript 'verify-epic73.ps1'
Run-VerifyScript 'verify-section-508-package.ps1'
Run-VerifyScript 'verify-section-508-template.ps1'
Run-VerifyScript 'verify-section-508-labels.ps1'
Run-VerifyScript 'verify-section-508-lookup.ps1'
Run-VerifyScript 'verify-section-508-editor.ps1'
Run-VerifyScript 'verify-section-508-product-config.ps1'
